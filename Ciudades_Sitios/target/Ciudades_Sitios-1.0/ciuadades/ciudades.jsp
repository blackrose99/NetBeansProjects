        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8 info-box">
                    ...
                    <h1 class="">
                        <i class="fas fa-city"></i> Ciudad de Barranquilla Colombia <!-- Agregamos un icono de ciudad al título -->
                    </h1>
                    <div class="container mt-5 card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 custom-column">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><i class="fas fa-globe-americas"></i> <strong>País:</strong> Colombia</li>
                                        <li><i class="fas fa-map"></i> <strong>Área:</strong> 152.9 km²</li>
                                        <li><i class="fas fa-users"></i> <strong>Población:</strong> 152.9 km²</li>
                        ...
                        <h1><i class="fas fa-binoculars"></i> Todos los Sitios Turísticos de Barranquilla</h1>
