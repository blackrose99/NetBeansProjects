...
public class SitiosDAO {
    ...
    private static final String buscarPorId = "SELECT id, name, direccion, descripcion, hora_inicio, hora_final, precio, foto FROM sitios_turisticos WHERE ciudad_id = ? order by name";
    ...
    public List<SitiosTuristicos> busquePorId(int id) {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                sitio.setFoto(resultado.getString("foto"));
                sitios.add(sitio);
            }
