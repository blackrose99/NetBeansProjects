...
public class CRventas {
    ...
    public void crearRegistro(int idprod, int idclie, int cantidad, int valorventa,int totalventa ,int empleado,int estado) {
        String query = "INSERT INTO ventas (idproducto,idcliente,cantidad,valor,total,idempleado,estado) VALUES (?,?,?,?,?,?,?)";
    ...
    public void leerRegistros(JTable Tabla) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                Comp [1]=resultSet.getInt("idcliente");
    ...
    public void leerRegistrosComboProd(JComboBox combo) {
     ...
     public void leerRegistrosComboClie(JComboBox combo) {
